...
@rem cpldfit -intstyle ise -p xc95144xl-10-TQ144 -ofmt vhdl -optimize density -htmlrpt -loc on -slew fast -init low -inputs %1 -pterms %2 -unused float -power std -terminate float SDRAM_IDE.ngd >log.txt
