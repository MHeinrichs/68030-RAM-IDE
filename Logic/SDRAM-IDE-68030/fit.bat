...
cpldfit -intstyle ise -p xc95288xl-10-TQ144 -ofmt vhdl -optimize speed -htmlrpt -loc on -slew fast -init low -inputs 36 -pterms 90 -unused float -power std -terminate float -exhaust SDRAM_IDE.ngd >>log.txt
